...
public class playmanActivity extends AppCompatActivity {
    ...
    private void result(int i) {
        String[] whoWon = {"No One", "Player 1","Player 2"};
        ...
        dialog.setTitle(whoWon[i] + " Won!")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(playmanActivity.this, MainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playman);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                color = turn1 ? R.drawable.redstar : R.drawable.greenstar;
                ...
                for(int i = 3; i >= 0; i--){
                    if (blocks[i][0].getTag().equals(R.drawable.yellowstar)) {
                        blocks[i][0].setImageResource(color);
                        blocks[i][0].setTag(color);
                        turn1 = !turn1;
            ...
            public void onClick(View v) {
                ...
                for(int i = 3; i >= 0; i--){
                    if (blocks[i][1].getTag().equals(R.drawable.yellowstar)) {
                        blocks[i][1].setImageResource(color);
                        blocks[i][1].setTag(color);
                        turn1 = !turn1;
                        if(checkWinner()) return;
                        break;
                    }
            ...
            public void onClick(View v) {
                ...
                for(int i = 3; i >= 0; i--){
                    if (blocks[i][2].getTag().equals(R.drawable.yellowstar)) {
                        blocks[i][2].setImageResource(color);
                        blocks[i][2].setTag(color);
                        turn1 = !turn1;
                        if(checkWinner()) return;
                        break;
                    }
            ...
            public void onClick(View v) {
                ...
                for(int i = 3; i >= 0; i--){
                    if (blocks[i][3].getTag().equals(R.drawable.yellowstar)) {
                        blocks[i][3].setImageResource(color);
                        blocks[i][3].setTag(color);
                        turn1 = !turn1;
                        if(checkWinner()) return;
                        break;
                    }
